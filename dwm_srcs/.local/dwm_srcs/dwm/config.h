...
#include <X11/XF86keysym.h>  // Include the XF86 keys
...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,		XK_l,            setlayout,      {0} },
...
/* application bindings */
	...
	{ MODKEY,			XK_e,          spawn,      {.v = (const char*[]){ "st", "-e", "nnn", NULL } } },
...
/* XF86 Keys*/
	...
	{ 0,				XF86XK_MonBrightnessUp,		spawn,		SHCMD("brightnessctl -q set +10%") },
	{ 0,				XF86XK_MonBrightnessDown,	spawn,		SHCMD("brightnessctl -q set 10%-") },
	{ 0,				XF86XK_Display,			spawn,		SHCMD("toggle-display") },
